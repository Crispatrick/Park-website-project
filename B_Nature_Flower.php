...
?>
    ...
    <section id="main">
                ...
                <section id="user_Info" class="form_Sections">
                    ...
                    <div class="inputs">
                        ...
                        <div id="pasigueno" class="types_Size types_Decor" style="background-color:rgba(255, 255, 255, 0);">
                            <div>
                                <input type="radio" id="yes" name="pasigueno" value="HTML">
                                <label for="yes">Yes</label>
                            </div>
                            <div>
                                <input type="radio" id="no" name="pasigueno" value="HTML">
                    ...
                    <div class="inputs">
                        ...
                        <textarea class="types_Decor" id="comment" name="comment" rows="4" cols="50" placeholder="Leave a message?"></textarea>
        ...
        <section id="info">
                <button class="accordion">Flower Park</button>
                <div class="panel">
                    <ul>
