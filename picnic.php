    ...
    <main>
        ...
        <section>
            <div id="cards">
                ...
                <div id="cards_Children">
                    <img src="Resources\Images\Leisure\Picnic_Grove\pg2.jpg" alt="">
                </div>
                <div id="cards_Children">
                    <img src="Resources\Images\Leisure\Picnic_Grove\pg3.jpg" alt="">
                </div>
                <div id="cards_Children">
                    <img src="Resources\Images\Leisure\Picnic_Grove\pg4.jpg" alt="">
                </div>
                <div id="cards_Children">
                    <img src="Resources\Images\Leisure\Picnic_Grove\pg5.jpg" alt="">
                </div>
        ...
        <section id="desc">
            ...
            <div id="solo_Attraction">
                <div id="description">
                <h2>PICNIC GROVE</h2>
                    <p>From being only a bare area with cottages before, an added attraction now rise for chess lovers. Here, big imitations of chess pieces are found. For those who love to play chess, you can move the chess pieces by lifting each because it is life-sized and made of concrete materials.</p>
                </div>
                <div id="rates">
                    <h4>Picnic Ground</h4>
                    <ul>
