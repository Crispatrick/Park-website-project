...
class bookingInfo{
    ...
    function __construct()
    {
        ...
        $this->Contact = $_SESSION["phone"];
        $this->Schedule = $_SESSION["schedule"];
        $this->Pax = $_SESSION["quantity"];
        $this->Pasigueno = $_SESSION["pasigueno"];
        $this->Comments = $_SESSION["comment"];
        $this->Payment = $_SESSION["payment"];

        $this->adventure = $_SESSION["adventure"];
        $this->nature = $_SESSION["nature"];
        $this->leisure = $_SESSION["leisure"];

        $this->sum = $_SESSION["sum"];
        $this->orig = $_SESSION["orig"];
    }
    function get_sum(){
        return $this->sum;
    }
    ...
    function get_leisure(){
        return 
            $this->leisure;
    }
}

$_SESSION["booked"] = new bookingInfo();
...
<body>
    ...
    <!-- <div class="blur-overlay"></div> -->
        <div id="receipt">
            <h3 id="receipt_Header" style="text-align: center;">OOP Format for receipt</h3> <br>
            <section id="personal_InfoCon">
                ...
                <section class="personal_Info">
                    <?php
                        echo "<div>" . $_SESSION["booked"]->get_name() . "</div>";
                        echo "<div>" . $_SESSION["booked"]->get_contacts() . "</div>";
            ...
            <?php
                echo "<div style=\"margin-right:100px; margin-left:100px;  text-align:center; background-color:var(--dark_Blue); padding:30px;\">" . $_SESSION["booked"]->get_comments() . "</div> <br>";
