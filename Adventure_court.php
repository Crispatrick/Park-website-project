    ...
    <main>
        ...
        <section>
            <div id="cards">
                ...
                <div id="cards_Children">
                    <img src="Resources\Images\Adventure\Court\tb2.jpg" alt="">
                </div>
                <div id="cards_Children">
                    <img src="Resources\Images\Adventure\Court\tb3.jpg" alt="">
                </div>
                <div id="cards_Children">
                    <img src="Resources\Images\Adventure\Court\tb4.jpg" alt="">
                </div>
            </div>
        </section>
        ...
        <section id="desc">
            <div id="solo_Attraction" style="justify-content: center; text-align:center">
                <div id="description">
                    <h2>Tennis & Basketball Courts</h2>
                    <p>Located side by side, RAVE’s sports facilities are sure to get your blood pumping for the thrill of the game.</p>
                </div>   
            </div>   
        </section>
